...
public enum SheetFormat { Png, Jpg, Webp }

/// <summary>Styling for a single text region (header, title, timestamp, signature).</summary>
public sealed class TextStyle
{
    public string? FontFamily { get; set; }          // null => default system font
    public string? FontFile { get; set; }            // explicit .ttf path, overrides FontFamily
...
/// <summary>All configurable settings for building a contact sheet, mirroring vcs.rb profiles.</summary>
public sealed class ContactSheetOptions
{
    ...
    // ---- Colors ----
    public SKColor SheetBackground { get; set; } = new(0x70, 0x80, 0x90); // SlateGray
